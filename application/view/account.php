    ...
    <div class="login-page">
        <div class="form">
            <div class="error">
                ...
                <input type="password" name="pw" id="pw" value="<?php echo $this->result["u_pw"] ?>" readonly>
                <label for="pwChk">CONFIRM PASSWORD</label>
                <input type="password" name="pwChk" id="pwChk" value="<?php echo $this->result["u_pw"] ?>" readonly>
                <label for="name">NAME</label>
                <input type="text" name="name" id="name" value="<?php echo $this->result["u_name"] ?>" readonly>
            </div>
